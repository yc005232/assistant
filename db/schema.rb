...
ActiveRecord::Schema.define(version: 20140524230902) do
  ...
  add_index "personnes_scenes", ["personne_id", "scene_id"], name: "index_personnes_scenes_on_personne_id_and_scene_id"
