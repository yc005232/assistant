...
describe ScenesController do
  ...
  let(:valid_attributes) { { "recit" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested scene" do
        ...
        Scene.any_instance.should_receive(:update).with({ "recit" => "MyString" })
        put :update, {:id => scene.to_param, :scene => { "recit" => "MyString" }}, valid_session
      end
